//
//  UILabel+BKAttributeTextTapAction.h
//
...
@protocol BKAttributeTapActionDelegate <NSObject>
@optional
/**
...
@interface BKAttributeModel : NSObject
...
@interface UILabel (BKAttributeTextTapAction)
